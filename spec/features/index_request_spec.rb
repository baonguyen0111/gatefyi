...
RSpec.describe "index page", type: :feature do
  ...
  before :each do
    Article.create!(:company => "Amazon", :industry_type => "Tech", :state => "WA", :city => "Seattle", :compensation => 100000, :interview_exp => "Pretty simple interview", :work_exp => "Great team. Challenging work", :upvotes => 0, admin_approved: true, :approved => DateTime.new(2020, 11, 04, 00, 00, 00))
    Article.create!(:company => "Uber", :industry_type => "Car", :state => "NY", :city => "New York", :compensation => 200000, :interview_exp => "Pretty simple interview", :work_exp => "Great team. Challenging work", :upvotes => 1, admin_approved: true, :approved => DateTime.new(2021, 11, 04, 00, 00, 00))
    Article.create!(:company => "Facebook", :industry_type => "SpyWare", :state => "NJ", :city => "Trenton", :compensation => 300000, :interview_exp => "Pretty simple interview", :work_exp => "Great team. Challenging work", :upvotes => 2, admin_approved: true, :approved => DateTime.new(2022, 11, 04, 00, 00, 00))
    Article.create!(:company => "Netflix", :industry_type => "Movies", :state => "ID", :city => "Cityland", :compensation => 500000, :interview_exp => "Pretty simple interview", :work_exp => "Great team. Challenging work", :upvotes => 3, admin_approved: true, :approved => DateTime.new(2024, 11, 04, 00, 00, 00))
    Article.create!(:company => "Google", :industry_type => "Search", :state => "MB", :city => "PlaceBerg", :compensation => 400000, :interview_exp => "Pretty simple interview", :work_exp => "Great team. Challenging work", :upvotes => 4, admin_approved: true, :approved => DateTime.new(2025, 11, 04, 00, 00, 00))
