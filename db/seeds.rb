...
#seed user
ulist << User.create!(name: "Linh Tran", email: "ltran@colgate.edu", provider: "google_oauth2", uid: "100000000000000000000", displayname: "ltran", description: "Colgate senior. Into research", show_profile: true)
ulist << User.create!(name: "Jeehuyn Park", email: "jpark@colgate.edu", provider: "google", uid: "100000000000000000001", displayname: "jpark", description: "Colgate sophomore", show_profile: true)
...
alist << Article.create!(company: "Goldman Sachs", industry_type: "Finance", state: "NY", city: "New York", compensation: 70000, interview_exp: "Modelling questions. Behavioral questions", work_exp: "Not so good experience, was overworked", upvotes: 0,admin_approved: true,  approved: DateTime.new(2020, 11, 04, 07, 00, 00), user_id: 2)

alist << Article.create!(company: "Business Ink", industry_type: "Business", state: "NY", city: "New York", compensation: 40000, interview_exp: "Logic type of questions", work_exp: "Not really vibing with my team", upvotes: 0,admin_approved: true, approved: DateTime.new(2020, 11, 04, 10,  00, 00), user_id: 2)
...
clist << Comment.create!(content: "I had a good interview tho", upvotes: 1, downvotes: 7, user_id: 2, article_id: 3)
clist << Comment.create!(content: "Nice!! So excited to apply!!", upvotes: 1, downvotes: 7, user_id: 1, article_id: 4)
clist << Comment.create!(content: "I don't think that salary is accurate for NY", upvotes: 1, downvotes: 7, user_id: 2, article_id: 5)
