...
RSpec.describe ArticlesController, type: :controller do 
	...
	context "index" do
		...
		it "renders the index template" do
			x, y = Article.create!(company: "Uber", industry_type: "Tech", state: "CA", city: "San Jose", compensation: 90000, interview_exp: "Hard interview. System design questions", work_exp: "get work in different teams, pretty cool perks", upvotes: 0, admin_approved: true, approved: DateTime.new(2020, 11, 04, 04, 00, 00)), Article.create!(company: "Amazon", industry_type: "Tech", state: "WA", city: "Seattle", compensation: 100000, interview_exp: "Pretty simple interview", work_exp: "Great team. Challenging work", upvotes: 0, admin_approved: true, approved: DateTime.new(2020, 11, 04, 03, 00, 00))
            get :index
